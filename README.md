...
- [Demo Applications](./demo/nuget-apps/) folder contains .Net applications to create demo NuGets.
  ...
  - [OpenMeteo.Api.Client](./demo/nuget-apps/OpenMeteo.Client/) is OpenAPI generated client.
- [Data](./demo/data/) folder with 
  - [NuGets Repo](/demo/data/nuget-repos/) folder contains *.nupkg files generated by demo app. Paths of this repos are defined in [Indexer Configuration](./docs/indexer-configuration.md)
  - [Indexer](./demo/data/indexer/) folder contains data for documents and NuGets indexing defined in [Indexer Configuration](./docs/indexer-configuration.md)
...
Run `Indexer` app once and review logs
